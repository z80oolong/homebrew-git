class GitAT220 < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/z80oolong/git-config-fix/master/git-2.20.0-fix.diff"
    sha256 "53cc98aa7120545923e9ada0bcf4ee8307fb5fd40ead5f62848c8204d5fa6464"
  end

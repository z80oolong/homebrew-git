class Git < Formula
  ...
  if build.head? then
    patch do
      url "https://raw.githubusercontent.com/z80oolong/diffs/master/git/git-HEAD-6f333ff2-fix.diff"
      sha256 "e2e213d7b47109e60d7e9cbf4501d8559edb573515c31091fd03a00a38584b69"
    end
  else
    patch do
